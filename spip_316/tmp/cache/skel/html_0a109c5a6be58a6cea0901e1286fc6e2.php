 ...
 * Date :      Wed, 19 Jul 2017 14:35:40 GMT
...
(($t1 = strval(interdire_scripts(filtre_introduction_dist($Pile[$SP]['descriptif'], (strlen($Pile[$SP]['descriptif']))
		...
		((	'<div class="' .
	classe_boucle_crayon('articles','intro',$Pile[$SP]['id_article']).' introduction entry-content">') . $t1 . '</div>') :
		'') .
'
		</li>
		');
...
// Temps de compilation total: 20.002 ms
//
