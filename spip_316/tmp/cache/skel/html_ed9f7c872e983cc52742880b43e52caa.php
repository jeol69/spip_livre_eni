			...
			<li>
				<div class="forum-message">
					<div class="forum-chapo">
						<strong class="' .
classe_boucle_crayon('forums','titre',$Pile[$SP]['id_forum']).' forum-titre"><a href="#forum' .
$Pile[$SP]['id_forum'] .
'" name="forum' .
$Pile[$SP]['id_forum'] .
'" id="forum' .
...
'
					...
					<div class="' .
classe_boucle_crayon('forums','texte',$Pile[$SP]['id_forum']).' forum-texte">
						' .
...
(($t1 = strval(safehtml(vider_url(calculer_url($Pile[$SP]['url_site'],'','url', $connect)))))!=='' ?
		((	'<p class="' .
	classe_boucle_crayon('forums','hyperlien',$Pile[$SP]['id_forum']).' hyperlien">' .
	$l2 .
...
// Temps de compilation total: 69.007 ms
//
